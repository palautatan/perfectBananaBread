...
---
# Regression
I am going to see if the recipe data is suitable for a linear regression.
...
## Conclusion
These data are not suitable for multiple linear regression.